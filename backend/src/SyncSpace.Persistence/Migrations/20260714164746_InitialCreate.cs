        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriveFiles_Users_UploadedById",
                        column: x => x.UploadedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriveFiles_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    WorkspaceId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriveFolders_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriveFolders_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Content = table.Column<string>(type: "text", nullable: false),
                    PositionStart = table.Column<int>(type: "integer", nullable: true),
                    PositionEnd = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardCards_Users_AssigneeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageEdits_Users_EditedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DirectMessageReactions_DirectMessages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "DirectMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "DirectMessageReadReceipts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MessageId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirectMessageReadReceipts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DirectMessageReadReceipts_DirectMessages_MessageId",
                        column: x => x.MessageId,
                        principalTable: "DirectMessages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DirectMessageReadReceipts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentCommentReactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentCommentReactions_DocumentComments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "DocumentComments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentCommentReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardActivities_BoardCards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardCardAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardCardAttachments_BoardCards_CardId",
                        column: x => x.CardId,
                        principalTable: "BoardCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardCardAttachments_Users_UploadedById",
                        column: x => x.UploadedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardCardComments_BoardCards_CardId",
                        column: x => x.CardId,
                        principalTable: "BoardCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardCardComments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardLabels_BoardCards_CardId",
                        column: x => x.CardId,
                        principalTable: "BoardCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_WorkspaceId_Action",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardActivities_BoardId_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardCardAttachments_CardId",
                table: "BoardCardAttachments",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCardAttachments_UploadedById",
                table: "BoardCardAttachments",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCardComments_CardId",
                table: "BoardCardComments",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCardComments_UserId",
                table: "BoardCardComments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCards_AssigneeId",
                table: "BoardCards",
                column: "AssigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCards_ColumnId",
                table: "BoardCards",
                column: "ColumnId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardCards_ColumnId_CreatedAt",
                table: "BoardCards",
                columns: new[] { "ColumnId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_BoardCards_ColumnId_Priority",
                table: "BoardCards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectMessageReactions_MessageId_UserId_Emoji",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectMessageReadReceipts_MessageId_UserId",
                table: "DirectMessageReadReceipts",
                columns: new[] { "MessageId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DirectMessageReadReceipts_UserId",
                table: "DirectMessageReadReceipts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentCommentReactions_CommentId_UserId_Emoji",
                table: "DocumentCommentReactions",
                columns: new[] { "CommentId", "UserId", "Emoji" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DocumentCommentReactions_UserId",
                table: "DocumentCommentReactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_WorkspaceId_IsDeleted",
                table: "Documents",
                columns: new[] { "WorkspaceId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Documents_WorkspaceId_UpdatedAt",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriveFiles_CreatedAt",
                table: "DriveFiles",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_DriveFiles_IsDeleted",
                table: "DriveFiles",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_DriveFiles_UploadedById",
                table: "DriveFiles",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_DriveFiles_WorkspaceId_FolderPath",
                table: "DriveFiles",
                columns: new[] { "WorkspaceId", "FolderPath" });

            migrationBuilder.CreateIndex(
                name: "IX_DriveFolders_CreatedById",
                table: "DriveFolders",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_DriveFolders_WorkspaceId_Path",
                table: "DriveFolders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageEdits_EditedById",
                table: "MessageEdits",
                column: "EditedById");
