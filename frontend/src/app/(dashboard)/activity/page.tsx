      ...
      <div className="space-y-8">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Audit trail across your workspaces</p>
            </div>
          </div>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <div className="py-20 text-center">
            ...
            <p className="mb-4 text-muted-foreground">Create a workspace to start tracking activity.</p>
          </div>
        ) : (
          <motion.div
          ...
          >
            {workspaces.map((ws) => (
              <Card
                ...
                onClick={() => router.push(`/workspaces/${ws.id}/activity`)}
              >
                <CardHeader>
