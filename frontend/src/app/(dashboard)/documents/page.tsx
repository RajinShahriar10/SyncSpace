      ...
      <div className="space-y-8">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Browse documents across your workspaces</p>
            </div>
          </div>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <div className="py-20 text-center">
            ...
            <p className="mb-4 text-muted-foreground">Create a workspace to start working with documents.</p>
