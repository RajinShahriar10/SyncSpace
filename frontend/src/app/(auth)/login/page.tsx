...
export default function LoginPage() {
  ...
  const { login, googleLogin, error, setError } = useAuthStore();
  ...
  const handleGoogleLogin = async () => {
    ...
    setError(null);
    try {
      // In production, use Google Identity Services to get the ID token
      // For now, prompt for a mock token
      const mockIdToken = prompt("Enter Google ID token (mock for development):");
      if (mockIdToken) {
